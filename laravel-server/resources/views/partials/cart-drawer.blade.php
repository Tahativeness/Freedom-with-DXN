...
<div x-show="$store.cart.open"
     ...
     class="absolute top-full {{ $isAr ? 'left-4 sm:left-6 lg:left-8' : 'right-4 sm:right-6 lg:right-8' }} mt-1 w-[22rem] max-w-[calc(100vw-2rem)] z-[70] origin-top-{{ $isAr ? 'left' : 'right' }}"
     style="display: none;"
     role="dialog"
