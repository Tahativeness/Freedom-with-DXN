...
<nav class="relative w-full bg-white shadow-sm z-50"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="nav-inner flex items-center justify-between h-24 transition-all duration-300">
            {{-- Logo --}}
            <a href="{{ route('home') }}" class="flex items-center gap-2 shrink-0">
                <img src="/footer-lg.png" alt="Grow with DXN - Home" width="200" height="96" class="nav-logo h-16 w-auto object-contain transition-all duration-300">
            </a>
