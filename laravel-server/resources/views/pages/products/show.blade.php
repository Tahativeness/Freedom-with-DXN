    ...
    <div class="max-w-7xl mx-auto px-4 pb-10">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-5">
                {{-- Category --}}
                <span class="inline-block text-xs font-semibold uppercase tracking-wide px-3 py-1 rounded-full mb-3" style="background-color: rgba(67,175,115,0.1); color: #43af73;">{{ $displayCategory }}</span>
            ...
            <div class="lg:col-span-3">
                <div class="border border-gray-200 rounded-2xl p-5 sticky top-24">
                    ...
                    <a href="{{ $whatsapp }}" target="_blank" rel="noopener noreferrer"
                       class="flex items-center justify-center gap-2 w-full text-white font-semibold py-3 px-4 rounded-xl transition-all mb-3 {{ !$product->in_stock ? 'opacity-40 pointer-events-none' : '' }}"
                       style="background-color: #25D366;"
                       onmouseenter="this.style.backgroundColor='#20ba5a'"
                    ...
                    <a href="{{ route('contact') }}"
                       class="flex items-center justify-center gap-2 w-full font-semibold py-3 px-4 rounded-xl transition-all border-2 text-sm"
                       style="border-color: #452aa8; color: #452aa8;"
                       onmouseenter="this.style.backgroundColor='#452aa8'; this.style.color='white'"
                       onmouseleave="this.style.backgroundColor='transparent'; this.style.color='#452aa8'">
